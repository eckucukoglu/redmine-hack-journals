...
get 'hackjournals/:issue_id/journals/:id/edit', :to => 'hackjournals#edit_journal', as: 'edit_journal'
delete 'hackjournals/:issue_id/journals/:id/', :to => 'hackjournals#destroy_journal', as: 'destroy_journal'
